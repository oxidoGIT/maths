const sections = [
  {
    ...
    exercises: [
      ...
      {
        tag: "Conservación",
        title: "Caída sin rozamiento",
        statement: "Una pelota de 0,5 kg cae desde 10 m. Si no hay rozamiento, calcula su velocidad justo antes de tocar el suelo.",
        type: "number",
        expected: [14],
        tolerance: 0.05,
        hint: "La Ep inicial se transforma en Ec final: m · g · h = 1/2 · m · v².",
        solution: "La masa se simplifica. v = √(2 · 9,8 · 10) = √196 = 14 m/s.",
      },
    ],
  },
  {
