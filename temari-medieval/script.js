...
const sourceParagraphs = {
  ...
  t4: "Es van expandir cap a França, Rússia, Anglaterra, Bretanya i el sud d'Itàlia a partir del canvi climàtic del segle IX. Comerciaven amb productes agrícoles i amb materials com l'ambre rus i la pell de marta.",
  t5: "Es van expandir cap a França, Rússia, Anglaterra, Bretanya i el sud d'Itàlia a partir del canvi climàtic del segle IX. Comerciaven amb productes agrícoles i amb materials com l'ambre rus i la pell de marta.",
  ...
  t7: "Tenien sagues escrites en rúnic i una religió politeista amb Thor, Odin, Loki i Freya. Políticament, apareixen relacionats amb Normandia, Anglaterra i Sicília.",
  t8: "Literatura: sagues escrites en rúnic, com les aventures d'Erik “El Rojo”. Religió: politeisme amb Thor, Odin, Loki, Freya i el Valhalla.",
  t9: "Literatura: sagues escrites en rúnic, com les aventures d'Erik “El Rojo”. Religió: politeisme amb Thor, Odin, Loki, Freya i el Valhalla.",
  ...
  t13: "Normandia: Rolland i Gisela, acord matrimonial, feudalisme i vassallatge. Anglaterra: 1066, Hastings, Guillem el Conqueridor i tapís de Bayeux. Sicília: mercenaris normands i regne multicultural amb Roger II.",
  t14: "Normandia: Rolland i Gisela, acord matrimonial, feudalisme i vassallatge. Anglaterra: 1066, Hastings, Guillem el Conqueridor i tapís de Bayeux. Sicília: mercenaris normands i regne multicultural amb Roger II.",
  ...
  t18: "Eren centres religiosos dirigits per monjos i monges. Protegien el coneixement mitjançant traduccions. Figures com Roswitha i Hildegarden de Bingen mostren que també hi havia dones cultes.",
  t19: "Eren centres religiosos dirigits per monjos i monges. Protegien el coneixement mitjançant traduccions. Figures com Roswitha i Hildegarden de Bingen mostren que també hi havia dones cultes.",
  t20: "Eren centres religiosos dirigits per monjos i monges. Protegien el coneixement mitjançant traduccions. Figures com Roswitha i Hildegarden de Bingen mostren que també hi havia dones cultes.",
  t21: "Eren centres religiosos dirigits per monjos i monges. Protegien el coneixement mitjançant traduccions. Figures com Roswitha i Hildegarden de Bingen mostren que també hi havia dones cultes.",
  t22: "Entre els segles XI i XII apareixen universitats a ciutats com Bolonya, París, Oxford o Lleida. Usaven el llatí i el mètode de l'escolàstica, basat en el diàleg entre professor i alumne.",
  t23: "Entre els segles XI i XII apareixen universitats a ciutats com Bolonya, París, Oxford o Lleida. Usaven el llatí i el mètode de l'escolàstica, basat en el diàleg entre professor i alumne.",
  t24: "Apareixen universitats com París, Oxford i Lleida, mentre creixen ciutats, fires i bancs. El temari situa aquest procés entre 1150 i 1300.",
  t25: "Universitat medieval: llengua, llatí; organització, estudiants segons el seu origen; suport, Església i monarquies; mètode, escolàstica, diàleg entre professor i alumne; exemple, Pere Abelard i Eloïsa.",
  t26: "Universitat medieval: llengua, llatí; organització, estudiants segons el seu origen; suport, Església i monarquies; mètode, escolàstica, diàleg entre professor i alumne; exemple, Pere Abelard i Eloïsa.",
  t27: "Universitat medieval: llengua, llatí; organització, estudiants segons el seu origen; suport, Església i monarquies; mètode, escolàstica, diàleg entre professor i alumne; exemple, Pere Abelard i Eloïsa.",
  t28: "L'escolàstica era el mètode universitari basat en el diàleg entre professor i alumne, i treballava a partir de textos d'Aristòtil.",
  t29: "Universitat medieval: llengua, llatí; organització, estudiants segons el seu origen; suport, Església i monarquies; mètode, escolàstica, diàleg entre professor i alumne; exemple, Pere Abelard i Eloïsa.",
  t30: "Les novel·les medievals tractaven política, cavalleria i amor cortès. Política: Dante i la “Monarquia”, amb l'objectiu d'aconseguir la pau. Cavalleria: rei Artur, taula rodona i recerca del Grial. Amor: Tristany i Isolda com a exemple d'amor cortès.",
  t31: "Les novel·les medievals tractaven política, cavalleria i amor cortès. Política: Dante i la “Monarquia”, amb l'objectiu d'aconseguir la pau. Cavalleria: rei Artur, taula rodona i recerca del Grial. Amor: Tristany i Isolda com a exemple d'amor cortès.",
  t32: "Les novel·les medievals tractaven política, cavalleria i amor cortès. Política: Dante i la “Monarquia”, amb l'objectiu d'aconseguir la pau. Cavalleria: rei Artur, taula rodona i recerca del Grial. Amor: Tristany i Isolda com a exemple d'amor cortès.",
  t33: "L'amor cortès és un gènere literari del segle XII lligat a Leonor d'Aquitània i a la cultura aristocràtica.",
  t34: "L'amor cortès és un gènere literari del segle XII lligat a Leonor d'Aquitània i a la cultura aristocràtica.",
  t35: "L'amor cortès presenta un triangle amorós, un amor prohibit amb secret i tensió, i una dona idealitzada que el cavaller converteix en protagonista.",
  t36: "L'amor cortès té l'origen al sud de França i a Aquitània. Les llengües associades al temari són la llengua d'Oc i l'alemany.",
  t37: "L'amor cortès es transmet amb trobadors i joglars: uns componien poemes i els altres els cantaven o recitaven.",
  t38: "Les Croades eren expedicions polítiques, militars i comercials organitzades per l'Església entre els segles XI i XIII.",
  t39: "Les Croades eren expedicions polítiques, militars i comercials organitzades per l'Església entre els segles XI i XIII.",
  t40: "Les Croades buscaven control social, lluita contra l'infidel i domini de les rutes comercials d'Orient. El 1095, el papa Urbà II impulsa una expedició des del concili de Clermont per ajudar l'imperi Bizantí i conquerir Jerusalem.",
  t41: "Les Croades buscaven control social, lluita contra l'infidel i domini de les rutes comercials d'Orient. El 1095, el papa Urbà II impulsa una expedició des del concili de Clermont per ajudar l'imperi Bizantí i conquerir Jerusalem.",
  t42: "Matèries primeres d'Orient: or i fusta com a productes valuosos, seda lligada al luxe i al comerç, i alum, fonamental per a les indústries tèxtils.",
  t43: "El 1099, els cavallers cristians prenen Jerusalem i funden un regne cristià.",
  t44: "El pelegrinatge cap a Jerusalem va portar reis i reines, com Leonor d'Aquitània. Per protegir els camins es va fundar l'ordre del Temple amb Hugo de Payns.",
  t45: "El 1187, Saladino reconquesta Jerusalem després de Hattin.",
  t46: "Les Croades van portar fruites com l'albercoc, estris com les forquilles, la cura del cos i un negoci important al voltant de la guerra.",
  t47: "Les Croades van provocar intercanvis culturals i també radicalització religiosa. En aquest context, Ramon Llull apareix com una figura que busca l'enteniment entre religions.",
  t48: "Bancs: institucions creades per intercanviar moneda i protegir els estalvis de les persones. Fires: espais comercials on s'acostumaven a vendre productes.",
  t49: "Lletres de canvi: documents que permetien cobrar diners en diferents territoris i facilitaven la mobilitat econòmica.",
  t50: "Els gremis eren organitzacions de comerciants i artesans que regulaven oficis i productes. Servien per formar, protegir condicions com el salari i vendre productes a fires molt cotitzades."
};
